...
\usepackage{bbm} % Make good looking indicator functions
...
\include{pattern_detection}

% Yu
\subsection{Initial look at the data}
\include{initial_data_analysis}
...
\include{color-optimisation}

% Yu
\subsection{Cross-color optimisation}
\include{cross-color-optimisation}
